...
fun differenceBetweenDays(
    ...
    maxDate: LocalDate = kotlin.time.Clock.System.now().toLocalDateTime(TimeZone.currentSystemDefault()).date,
): Int {
...
fun getLast52Weeks(): List<Pair<String, List<LocalDate>>> {
    val thisYear = kotlin.time.Clock.System.now().toLocalDateTime(TimeZone.currentSystemDefault()).year
